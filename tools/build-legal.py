...
PRIVACY = [
    ...
    # Enquiries now go to BizzFlowUK as well as by email (September 2026). What
    # is known about that flow is stated plainly; what only the client or
    # LaunchFlow can confirm stays bracketed, same as the rest of this notice.
    ("p", "Our WordPress enquiry forms send your details to our configured enquiry service by email, and also to BizzFlowUK, the customer management system we use to record, manage and respond to enquiries. BizzFlowUK is provided to us by LaunchFlow UK Limited, which processes this information on our behalf. [CONFIRM A DATA PROCESSING AGREEMENT WITH LAUNCHFLOW UK LIMITED IS IN PLACE.] Access is restricted to authorised people who need it. We use Hostinger to host this website and our email, which is how enquiries reach us. These providers process information for the purposes described here under the relevant arrangements."),
    ("p", "If BizzFlowUK cannot be reached at the moment you submit an enquiry, the website keeps a copy for no longer than 24 hours while it retries, then deletes it whether or not delivery succeeded. The website does not otherwise keep a copy of your enquiry."),
    ("h", "Transfers outside the UK"),
    ("p", "BizzFlowUK stores enquiry information on servers in the European Union provided by Hetzner Online GmbH. The UK recognises the European Economic Area as giving personal information an adequate level of protection, so no additional transfer safeguards are needed for this. [CONFIRM THE HOSTINGER DATA CENTRE LOCATION FOR THIS WEBSITE AND MAILBOX; IF IT IS OUTSIDE THE UK AND EEA, EXPLAIN THE SAFEGUARD.] Contact us if you would like more information about where your information is held."),
    ("h", "How long we keep information"),
    ("p", "We keep unsuccessful or inactive enquiries, including those recorded in BizzFlowUK, for [APPROVED PERIOD OR EXPLAINED CRITERIA]. Customer and transaction records are retained for [APPROVED PERIOD/CRITERIA AND REASON]. Technical security logs are retained for [APPROVED PERIOD]. We then delete or anonymise information unless a continuing legal reason requires retention. Backup deletion follows [APPROVED BACKUP CYCLE]."),
    ...
    ("p", "See our cookie notice for information about technologies used on this website. Following a directions or review link takes you to a separate service with its own privacy information. The website does not use embedded maps, videos or analytics."),
...
COOKIES = [
    ...
    ("p", "The public website does not set cookies or store information on your device when you browse it or send an enquiry. When you submit a form, the page asks our server for a one-time security code that protects the form from misuse; it is held only in the open page and is not saved on your device."),
    ("p", "The public website operates without analytics or advertising trackers. Logged-in administration may use technologies for authentication that do not apply in the same way to an ordinary visitor. The enquiry planner keeps your selections only in the open page; they are not saved on your device and reach us only if you submit the enquiry."),
    ("h", "Your choices"),
    ("p", "We do not currently use optional analytics or advertising cookies on the public website. If that changes, we will update this notice and introduce the required controls before using them."),
